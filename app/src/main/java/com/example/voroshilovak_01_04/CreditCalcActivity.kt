...
class CreditCalcActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        date = findViewById(R.id.date_in_month)
        payment = findViewById(R.id.month_payment)
    }
    ...
    fun Calc(view: View) {
        ...
        when{
            ...
            date.text.toString().toDouble()>=12 && date.text.toString().toDouble()<24->{
                val temp = slider.progress / date.text.toString().toDouble() + slider.progress*0.59
        ...
        payment.text = Math.round(result).toString()
